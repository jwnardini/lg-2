...
$atts=shortcode_atts(array('cat' => '0'), $atts);
                        ...
                        <li class="news"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php  the_title() ?>" class="news-title"><?php the_title(); ?></a></li>
             <?php the_excerpt(); ?>
                        <?php endwhile; ?>
             <?php if ( has_post_thumbnail()) : ?>
               <li class="news"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" >
