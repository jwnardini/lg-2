...
define('DB_NAME', 'lightingglobal_stg');

/** MySQL database username */
define('DB_USER', 'dbadmlgstage');
...
define('WP_HOME','http://staging.lightingglobal.org');
define('WP_SITEURL','http://staging.lightingglobal.org');
